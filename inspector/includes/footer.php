 ...
 ">
  <hr class = "bg-dark">
  <!-- <h3 class="text-center " style="margin-left: -200px;"> BFP || Bureau of Fire Protection  </h3> -->
  <div class="copyright text-lg text-muted text-lg-start " style = "position: fixed;  bottom:0;"> 
