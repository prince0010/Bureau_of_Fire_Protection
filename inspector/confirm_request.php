                ...
                <input type="hidden" value =<?=$user['data']['id'];?> name = "durationId" required>
                      ...
                      <?php
                        ...
                        ?>  
                                    ...
                                    <div class="mb-3">
                                        <label > Remarks </label>
                                        <textarea name="remarks" cols="30" rows="2" class ="form-control"><?=$user['data']['remarks'] ?> </textarea>
                                    </div>
                                    </div>
                                    <!-- <div class="col-md-6">
                                    <div class="mb-3">
                                        <label > Set Schedule </label>
                                        <input type="date" name = "datetime_local" class="form-control my-2">
                                    </div>
                                    </div> -->
                                    <div class="col-md-6">
                        <div class="mb-3">
                        <button type = "submit" name = "confirm_data" class="btn btn-dark">Confirm</button>
                    </div>
