        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h3> Inspection Order
                        <a href="inspection_order_data.php" class="btn btn-dark float-end "> Back </a> 
                        <a href="printing.php?id=<?= $paramResult?>" class="btn btn-dark float-end mx-2"> Print I/O </a>
                    </h3>
                    <hr class="bg-dark">

                </div>
                <div class="card-body">
                    <h3>Inspection Order Data</h3>
                    <div id="alertmessage">
                        <?= alertMessage(); ?>
                    </div>  
                    <br/>
