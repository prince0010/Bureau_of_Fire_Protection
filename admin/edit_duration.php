...
<div class="row">
        ...
        $user = getByID('duration',checkParamId('id'));
            ...
            ?>
                <input type="hidden" value =<?=$user['data']['id'];?> name = "durationId" required>
                        ...
                        <div class="mb-3">
                                ...
                                <textarea name="duration" cols="30" rows="10" class ="form-control"><?=$user['data']['duration'] ?> </textarea>
                            </div>
                        <div class="col-md-6">
                        <div class="mb-3">
                            <button type = "submit" name = "updateDuration" class="btn btn-dark"> Save </button>
                    </div>
                        </div>
                            </div>
                        </div>
