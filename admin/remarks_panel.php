            ...
            <form action="" method = "GET">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <a href = "remarks_panel.php" class = "btn btn-danger">Reset</a>
                    </div>
                </div>
            </form>
        </div>
                ...
                <div id ="alertmessage">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <td class = "text-center">
                                        <a  href="edit_remarks.php?id=<?= $servicesItem['id']?>" class = "btn btn-success btn-sm"><i style="font-size:17px" class="fa fa-check"></i></a>
                                        <a href="delete_remarks.php?id=<?= $servicesItem['id']?>"
