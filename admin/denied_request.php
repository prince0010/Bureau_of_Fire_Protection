...
?>
                <div class="card-header">
                    <h4> Denied Request
                        <a href="confirm_inspection_data.php?id=<?=$user['data']['id'];?>" class="btn btn-dark float-end">Back</a>
                    </h4>
                   ...
                   <input type="hidden" value =<?=$user['data']['id'];?> name = "userId" required>
                         ...
                         <div class="row">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="col-md-3">
                                <div class="mb-3">
                                    <button type = "submit" name = "updateDenied" class="btn btn-dark"> Update </button>
                                    </div>
                            </div>
                                </div>
                        </div>
